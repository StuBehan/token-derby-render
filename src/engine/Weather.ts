...
export class WeatherManager {
  ...
  private getParamsForType(type: WeatherType): WeatherParams {
    switch (type) {
      ...
      case 'very_cloudy':
        return {
          skyTopColor: new THREE.Color(0x7d909c),
          skyHorizonColor: new THREE.Color(0xc0cbd0),
          backgroundColor: new THREE.Color(0xbcc6cc),
          fogColor: new THREE.Color(0xbcc6cc),
          fogNear: 80,
          fogFar: 200,
          ambientColor: new THREE.Color(0xc4d5e0),
          ambientGroundColor: new THREE.Color(0x525c42),
          ambientIntensity: 2.0,
          sunColor: new THREE.Color(0xdfe8f0),
          sunIntensity: 1.6,
          cloudCount: 16,
          cloudColor: new THREE.Color(0xeeeeee),
          cloudMinSpeed: 4.5,
          cloudMaxSpeed: 9.0,
          rainIntensity: 0.0,
          rainSpeedMultiplier: 1.0,
